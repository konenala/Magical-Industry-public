...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> MAGIC_ORE_PLACED_KEY = registerKey("magic_ore_placed");
  ...
  //  public static final ResourceKey<PlacedFeature> END_SAPPHIRE_ORE_PLACED_KEY = registerKey("end_sapphire_ore_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, MAGIC_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_MAGIC_ORE_KEY),
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(MagicalIndustryMod.MOD_ID, name));
    }
