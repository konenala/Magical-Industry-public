...
/**
 * Interface describing the base methods common to all mana-related inputs of our recipes.
 */
@MethodsReturnNonnullByDefault
public interface ManaInputIngredient<TYPE> extends Predicate<TYPE> {
    ...
    /**
     * Primarily for display purposes, a list of valid instances of the type.
     *
